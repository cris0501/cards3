<template>
  <div class="flex items-center justify-center fixed top-0 left-0 w-screen h-[100vh] bg-gray-800/80 z-30" @click="exit">
    <div class="flex flex-col justify-center items-center w-5/6 rounded-lg bg-slate-200 dark:bg-slate-800 px-4 py-6 space-y-5">
      ...
      <div class="flex flex-col lg:flex-row w-5/6 lg:space-x-5">
        ...
        <div class="flex flex-1 flex-col space-y-3 mt-4">
          ...
          <input type="text" v-model="word.side_1" placeholder="Frontal" class="dark:bg-slate-700 dark:text-white dark:border-slate-600">
          <input type="text" v-model="word.info_1" placeholder="Informacion" class="dark:bg-slate-700 dark:text-white dark:border-slate-600">

          <!-- Selector de imagen para la cara frontal -->
          <div class="flex flex-col space-y-1">
            <input type="file" accept="image/*" class="hidden" ref="fileImg1" @change="handleImg1">
            <button type="button" class="text-left text-sm px-2 py-1 rounded bg-white dark:bg-slate-600 dark:text-white border"
          ...
          <input type="text" v-model="word.sound_1" placeholder="Audio" class="dark:bg-slate-700 dark:text-white dark:border-slate-600">
        </div>

        <div class="flex flex-1 flex-col space-y-3 mt-4">
          <p class="text-right font-bold dark:text-white"> Trasera </p>
          <input type="text" v-model="word.side_2" placeholder="Trasera" class="dark:bg-slate-700 dark:text-white dark:border-slate-600">
          <input type="text" v-model="word.info_2" placeholder="Informacion" class="dark:bg-slate-700 dark:text-white dark:border-slate-600">
          ...
          <input type="text" v-model="word.sound_2" placeholder="Audio" class="dark:bg-slate-700 dark:text-white dark:border-slate-600">
        </div>

      </div>
      <div class="flex w-5/6">
        <input type="text" v-model="word.category" placeholder="Categoria" class="flex-1 dark:bg-slate-700 dark:text-white dark:border-slate-600">
      </div>
