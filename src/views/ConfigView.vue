<template>
  <div class="flex flex-col w-full h-full p-8">
    ...
    <div class="flex items-center justify-between mb-6">
      ...
      <button @click="sysStore.toggleDarkMode" class="p-2 rounded-lg bg-slate-200 dark:bg-gray-700">
    ...
    <div class="flex flex-col space-y-3 w-5/6 lg:w-3/4 mx-auto">
      ...
      <div v-for="cat in categoryNames" :key="cat"
        class="border rounded-xl overflow-hidden shadow-sm bg-white dark:bg-gray-800 dark:border-gray-700">
